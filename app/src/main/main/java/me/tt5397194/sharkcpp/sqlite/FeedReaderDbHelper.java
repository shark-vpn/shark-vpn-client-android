...
public class FeedReaderDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_VPN_CONFIG =
            ...
            "server_port INTEGER, password TEXT, local_ip TEXT, dns_addr TEXT, mtu INTEGER);";
    ...
    private static final String SQL_INSERT_BASE_DATA1 =
            "insert into vpn_config(name, server_addr, server_port, password, local_ip, dns_addr, mtu) " +
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("ALTER TABLE vpn_config ADD COLUMN mtu INTEGER ;");
        /*
